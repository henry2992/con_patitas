 ...
 **************************************************************** **/
	...
	//	For notification bar
			...
			if($(this).hasClass('notification')){
                var _quick_cart_box = jQuery('li.quick-cart.notification div.quick-cart-box.notification');
			}else{
				var _quick_cart_box = jQuery('li.quick-cart.cart div.quick-cart-box.cart');
            }
 ...
 **************************************************************** **/
	function _form() {
		...
		if(jQuery('form.validate-plugin').length > 0) {
			...
			loadScript(plugin_path + '/js/form.validate/jquery.form.min.js', function() {
				loadScript(plugin_path + '/js/form.validate/jquery.validation.min.js');
			});
		...
		if(jQuery('form.validate').length > 0) {
			...
			loadScript(plugin_path + '/js/form.validate/jquery.form.min.js', function() {
				loadScript(plugin_path + '/js/form.validate/jquery.validation.min.js', function() {
 ...
 **************************************************************** **/
	function _pickers() {
		...
		if(_container_1.length > 0) {
			loadScript(plugin_path + 'js/bootstrap-datepicker.min.js', function() {
				...
				if(jQuery().datepicker) {
					...
					_container_1.each(function() {
						...
						if(_lang != 'en' && _lang != '') { // load language file
							loadScript(plugin_path + 'js/locales/bootstrap-datepicker.'+_lang+'.min.js');
						}
		...
		if(_container_2.length > 0) {
			loadScript(plugin_path + 'js/moment.min.js', function() {
				loadScript(plugin_path + 'js/daterangepicker.js', function() {
 ...
 **************************************************************** **/
	...
	// 	if(_container_1.length > 0) {
	//
	// 		loadScript(plugin_path + '/js/editor.summernote/summernote.min.js', function() {
	//
	...
	// 					alert(_lang);
	// 						loadScript(plugin_path + '/js/editor.summernote/lang/summernote-'+_lang+'.js');
	// 					}
    //
	...
	// 	if(_container_2.length > 0) {
	//
	// 		loadScript(plugin_path + '/js/editor.markdown/js/bootstrap-markdown.min.js', function() {
	//
	// 			if(jQuery().markdown) {
    //
	// 				_container_2.each(function() {
	...
	// 						loadScript(plugin_path + '/js/editor.markdown/locale/bootstrap-markdown.'+_lang+'.js');
	// 					}
    //
