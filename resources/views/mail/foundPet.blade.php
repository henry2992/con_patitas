                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h1 style="text-align: center;"><strong>Encontré tu mascota</strong></h1>
<br>
<br>
<span style="font-size:16px"><strong>Hola, {{$to}}</strong></span><br>
&nbsp;
<p><span style="font-size:15px">{{$contents}}</span></p>

<p><span style="font-size:14px">Mi correo electrónico es {{$from}}</span></p>
